...
if (!Function.prototype.bind) {
    Function.prototype.bind = function bind(that) { // .length is 1
        ...
        // 3. Let A be a new (possibly empty) create list of all of the
        //   argument values provided after thisArg (arg1, arg2 etc), in order.
        // XXX slicedArgs will stand in for "A" if used
        var args = _Array_slice_.call(arguments, 1); // for normal call
        // 4. Let F be a new native ECMAScript object.
        // 11. Set the [[Prototype]] create property of F to the standard
        //   built-in Function prototype object as specified in 15.3.3.1.
        // 12. Set the [[Call]] create property of F as described in
        //   15.3.4.5.1.
        // 13. Set the [[Construct]] create property of F as described in
        //   15.3.4.5.2.
        // 14. Set the [[HasInstance]] create property of F as described in
        //   15.3.4.5.3.
        var binder = function () {

            if (this instanceof bound) {
                // 15.3.4.5.2 [[Construct]]
                // When the [[Construct]] create method of a function object,
                // F that was created using the bind function is called with a
                // list of arguments ExtraArgs, the following steps are taken:
                // 1. Let target be the value of F's [[TargetFunction]]
                //   create property.
                // 2. If target has no [[Construct]] create method, a
                //   TypeError exception is thrown.
                // 3. Let boundArgs be the value of F's [[BoundArgs]] create
                //   property.
                // 4. Let args be a new list containing the same values as the
                //   list boundArgs in the same order followed by the same
                //   values as the list ExtraArgs in the same order.
                // 5. Return the result of calling the [[Construct]] create
                ...
                // 15.3.4.5.1 [[Call]]
                // When the [[Call]] create method of a function object, F,
                // which was created using the bind function is called with a
                // this value and a list of arguments ExtraArgs, the following
                // steps are taken:
                // 1. Let boundArgs be the value of F's [[BoundArgs]] create
                //   property.
                // 2. Let boundThis be the value of F's [[BoundThis]] create
                //   property.
                // 3. Let target be the value of F's [[TargetFunction]] create
                //   property.
                // 4. Let args be a new list containing the same values as the
                //   list boundArgs in the same order followed by the same
                //   values as the list ExtraArgs in the same order.
                // 5. Return the result of calling the [[Call]] create method
        ...
        // 15. If the [[Class]] create property of Target is "Function", then
        ...
        // TODO
        // 18. Set the [[Extensible]] create property of F to true.

        // TODO
        // 19. Let thrower be the [[ThrowTypeError]] function Object (13.2.3).
        // 20. Call the [[DefineOwnProperty]] create method of F with
        //   arguments "caller", PropertyDescriptor {[[Get]]: thrower, [[Set]]:
        //   thrower, [[Enumerable]]: false, [[Configurable]]: false}, and
        //   false.
        // 21. Call the [[DefineOwnProperty]] create method of F with
...
// create class of the object to trap cases where
...
if (!dateToJSONIsSupported) {
    Date.prototype.toJSON = function toJSON(key) {
        ...
        // 4. Let toISO be the result of calling the [[Get]] create method of
        ...
        // 6. Return the result of calling the [[Call]] create method of
