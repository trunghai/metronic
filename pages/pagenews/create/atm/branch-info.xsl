				...
				<div id="mainViewContent" class="main-layout-subview">
					<div class="panelContent" style="padding-top:20px">
						<table width="100%" align="center">
							<tr>
								<td colspan="2">
									<h5 align="left" class="screen-title"><span>BANK_INFO_BRANCH_TITLE</span></h5>
							...
							<tr>
								<td colspan="2" id='bankinfo.btn.back'>
									<div class="btnshadow btn-primary" onclick="navController.popView(true);"><span>CM_BTN_GOBACK</span></div>
								</td>
							</tr>
						</table>
					</div>
