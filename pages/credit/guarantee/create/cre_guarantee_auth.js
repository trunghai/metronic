...
function init() {
    angular.module('EbankApp').controller('cre_guarantee_review', function ($scope, requestMBServiceCorp) {
        ...
        $scope.sendJSONRequest = function () {
            ...
            var request = {
                ...
                request: {
                    ...
                    sequence_id: 3,
                    idtxn: gTrans.idtxn,
                    noteProfile: gTrans.infoGuarantee.instructionFile,
            ...
            requestMBServiceCorp.post(data, true, function (response){
                ...
                navCachedPages["credit/guarantee/create/cre_guarantee_result"] = null;
                navController.pushToView("credit/guarantee/create/cre_guarantee_result", true);
        ...
        function handleOTPTimeout() {
            ...
            clearOTPTimeout();
            if (currentPage == "credit/guarantee/create/cre_guarantee_auth"){
