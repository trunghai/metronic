        ...
        $scope.onContinuteClick = function () {
            ...
            // if($scope.check == 'B02'){
                // var request = {
                    ...
                    // }
                // }
            // }else if($scope.check == 'C03'){
                var request = {
                    cmdType: CONSTANTS.get("CMD_MANAGER_CRE_REQUEST"),
                    request: {
                        transIds: gTrans.detail.IDFCATREF,
                        sequence_id: "3",
                        idtxn: "C03"
            ...
            requestMBServiceCorp.post(data,true, function (response) {
                if (response.respCode == '0'){
                    ...
                    navCachedPages["credit/manager_guarantee/manager-cre-request-detail-result"] = null;
                    navController.pushToView("credit/manager_guarantee/manager-cre-request-detail-result", true, 'html');
                }else {
