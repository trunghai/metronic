...
function initData() {
    angular.module('EbankApp').controller('request-release-LC-authen', function ($scope, requestMBServiceCorp) {
        ...
        $scope.statusVN = {"ABH" : "Hoàn thành", "INT": "Chờ duyệt", "REJ": "Từ chối", "APT": "Duyệt một phần", "RBH": "Duyệt không thành công", "CAC": "Hủy giao dịch", "STH" : "Đang xử lý",
        ...
        $scope.feeMethod = {"N" : "Chúng tôi chịu", "Y" : "Người nhận chịu"};
        ...
        $scope.onCancelClick = function () {
            ...
            navController.popToView('international_payments/request_release_LC/manager_LC/request-release-LC-mng', true, 'html');
        }
        ...
        $scope.onContinuteClick = function () {
            ...
            var args = [];
            var request = {
                cmdType: CONSTANTS.get("CMD_MANAGER_LC"),
                request: {
                    transIds: gTrans.detail.MA_GD,
                    sequence_id: "4",
                    idtxn: "B04"
                }
            }
            ...
            requestMBServiceCorp.post(data,true, function (response) {
                if (response.respCode == '0'){
                    ...
                    gTrans.manaLC = gTrans.result.respJsonObj;
                    if (response.respCode === '0'){
                    ...
                    navCachedPages["international_payments/request_release_LC/manager_LC/request-release-LC-result"] = null;
                    navController.pushToView("international_payments/request_release_LC/manager_LC/request-release-LC-result", true, 'html');
                }else {
        ...
        function handleOTPTimeout() {
            ...
            clearOTPTimeout();
            if (currentPage == "international_payments/request_release_LC/manager_LC/request-release-LC-authen") {
