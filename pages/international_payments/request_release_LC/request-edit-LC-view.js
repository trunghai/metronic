...
function init() {
    angular.module('EbankApp').controller('request-edit-lc-view', function ($scope, requestMBServiceCorp) {
        clearCache = true;
        ...
        $scope.onContinuteClick = function () {
            gTrans.requestlc.src = 'pages/international_payments/request_release_LC/edit-LC-view-info.html';
