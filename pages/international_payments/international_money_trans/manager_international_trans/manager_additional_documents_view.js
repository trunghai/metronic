...
function initData() {
    angular.module("EbankApp").controller("manager_additional_documents_view", function ($scope, requestMBServiceCorp) {
        ...
        $scope.onContinuteClick = function () {
            navCachedPages['international_payments/international_money_trans/manager_international_trans/manager_additional_documents_authen'] = null;
            navController.pushToView('international_payments/international_money_trans/manager_international_trans/manager_additional_documents_authen', true, 'html');
        }
