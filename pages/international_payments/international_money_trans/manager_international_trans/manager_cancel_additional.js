...
function initData() {
    angular.module('EbankApp').controller('manager_cancel_additional', function ($scope, requestMBServiceCorp) {
        ...
        $scope.onCancelClick = function () {
            navCachedPages['international_payments/international_money_trans/manager_international_trans/manager_cancel_additional_authen'] = null;
            navController.pushToView("international_payments/international_money_trans/manager_international_trans/manager_cancel_additional_authen", true, "html");
        }
