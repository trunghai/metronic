...
//            navPushToView("international_payments/international_money_trans/manager_international_trans/manager_cancel_additional_result");
        }
        ...
        $scope.onContinuteClick = function () {
            ...
            requestMBServiceCorp.post(data, true, function (response) {
                if (response.respCode == '0'){
                    ...
                    navCachedPages["international_payments/international_money_trans/manager_international_trans/manager_cancel_additional_result"] = null;
                    navController.pushToView("international_payments/international_money_trans/manager_international_trans/manager_cancel_additional_result", true, 'html');
                }else {
