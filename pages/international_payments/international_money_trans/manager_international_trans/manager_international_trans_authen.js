...
function initData() {
    angular.module('EbankApp').controller('manager_international_trans_authen', function ($scope, requestMBServiceCorp) {
        ...
        $scope.onBackClick = function () {
            ...
            navController.popView("international_payments/international_money_trans/manager_international_trans/manager_international_trans_detail",true,"html")
        }
        ...
        $scope.onContinuteClick = function () {
            ...
            requestMBServiceCorp.post(data, true, function (response) {
                if (response.respCode == '0'){
                    ...
                    navCachedPages["international_payments/international_money_trans/manager_international_trans/manager_international_trans_result"] = null;
                    navController.pushToView("international_payments/international_money_trans/manager_international_trans/manager_international_trans_result", true, 'html');
                }else {
