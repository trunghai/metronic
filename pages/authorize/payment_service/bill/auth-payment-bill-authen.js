...
function initData() {
    angular.module('EbankApp').controller('auth_payment_bill_authen', function ($scope, requestMBServiceCorp) {
        ...
        $scope.authorizationTrans = function () {
            ...
            if (gTrans.authen){
                ...
                requestMBServiceCorp.post(data, true, function (response){
                    ...
                    navCachedPages["authorize/payment_service/bill/auth-payment-bill-result"] = null;
                    navController.pushToView("authorize/payment_service/bill/auth-payment-bill-result", true);
        ...
        function handleOTPTimeout() {
            ...
            clearOTPTimeout();
            if (currentPage == "authorize/payment_service/bill/auth-payment-bill-authen"){
