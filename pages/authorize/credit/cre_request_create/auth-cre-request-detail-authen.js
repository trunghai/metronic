...
function initData() {
    angular.module("EbankApp").controller('auth-cre-request-detail-authen', function ($scope, requestMBServiceCorp) {
        ...
        $scope.onBackClick = function () {
            ...
            navController.pushToView("authorize/credit/cre_request_create/auth-cre-request-detail",true,"html");
        }
        ...
        $scope.onContinuteClick = function () {
            ...
            if (gTrans.common.authen){
                ...
                var request = {}
                gTrans.transInfo = [];
                gTrans.transInfo.push({'transId': gTrans.common.transId, 'userIdRef': gTrans.common.idUserRef, 'form' :gTrans.common.form_value});
            ...
            requestMBServiceCorp.post(data, true, function (response) {
                ...
                navCachedPages["authorize/credit/cre_request_create/auth-cre-request-detail-result"] = null;
                navController.pushToView("authorize/credit/cre_request_create/auth-cre-request-detail-result", true);
            });
