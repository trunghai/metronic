    ...
    angular.module("EbankApp").controller('auth-guarantee-detail-authen', function ($scope, requestMBServiceCorp) {
        ...
        $scope.onContinuteClick = function () {
            ...
            if (gTrans.common.authen){
                ...
                var request = {}
                gTrans.transInfo = [];
                gTrans.transInfo.push({'transId': gTrans.common.transId, 'userIdRef': gTrans.common.idUserRef, 'guaranteeType':gTrans.common.guaranteeType});
            ...
            requestMBServiceCorp.post(data, true, function (response) {
                ...
                navCachedPages["authorize/credit/guarantee/auth-guarantee-detail-result"] = null;
                navController.pushToView("authorize/credit/guarantee/auth-guarantee-detail-result", true);
            });
        ...
        function handleOTPTimeout() {
            ...
            clearOTPTimeout();
            if (currentPage == "authorize/credit/guarantee/auth-guarantee-detail-authen"){
