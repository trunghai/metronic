...
function viewDidLoadSuccess() {
    setTitleBar(CONST_STR.get('AUTHORIZE_TRANS_TIT_T21'));
...
function init() {
    angular.module("EbankApp").controller("account-trans-auth-src", function ($scope, requestMBServiceCorp) {
        clearCache = true;
        ...
        // $scope.src = 'pages/authorize/transfer/search-pending/account/auth-trans-account-desk-list.html';
        ...
        $scope.initData = function () {
            ...
            args.push(null);
            args.push(jsonData);
            var gprsCmd = new GprsCmdObj(CONSTANTS.get("CMD_CO_AUTHORIZE_ACCOUNT"), "", "", gUserInfo.lang, gUserInfo.sessionID, args);
...
//    Loai giao dich
        ...
        function showTransTypeSelectionOpen(e) {
            if (currentPage == "authorize/transfer/search-pending/account/account-trans-auth-src") {
                if ((e.selectedValue1 != undefined) && (e.selectedValue1 != null) && e.selectedValue2 == 'T71') {
...
//        end Loai giao dich
        ...
        $scope.goToViewScreen = function(e){
            ...
            if(gTrans.transInfo.NGUOI_CHIU_PHI == "N" ){
                gTrans.transInfo.nguoichiuphi = CONST_STR.get("IDENTIFICATION_FEE_RECEIVER_PAY");
            }else{
                gTrans.transInfo.nguoichiuphi = CONST_STR.get("IDENTIFICATION_FEE_SENDER");
            }
            gTrans.transInfo.guitb = CONST_STR.get("COM_NOTIFY_1");
//            gTrans.transInfo.qlthuhuong = "Không lưu";
            gTrans.transInfo.BALANCE_FINAL = gTrans.transInfo.SO_DU_KHA_DUNG -  gTrans.transInfo.SO_TIEN  - gTrans.transInfo.PHI_DV;
            gTrans.idtxn = 'T71';
            gTrans.cmdType = CONSTANTS.get('CMD_CO_AUTHORIZE_ACCOUNT');
            gTrans.scr = 'pages/authorize/transfer/search-pending/account/auth-once-trans-account-view.html';
            gTrans.srcViewListPending = 'authorize/transfer/search-pending/account/account-trans-auth-src';
...
//            gTrans.listRequset.push(gTrans.obj);
            ...
            gTrans.cmdType = CONSTANTS.get('CMD_CO_AUTHORIZE_ACCOUNT');
            gTrans.srcViewListPending = 'authorize/transfer/search-pending/account/account-trans-auth-src';
            gTrans.srcAuthenDesktop = 'pages/authorize/transfer/search-pending/account/auth-review-trans-account-desktop.html';
            gTrans.srcAuthenMobile = 'pages/authorize/transfer/search-pending/account/auth-review-trans-account-mobile.html';
