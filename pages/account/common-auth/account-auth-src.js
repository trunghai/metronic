        ...
        $scope.sendJSONAuthenRequest = function () {
            ...
            var request = {
                ...
                request: {
                    ...
                    idfcatref : gTrans.transInfo.transId,
            ...
            requestMBServiceCorp.post(data, true, function (response) {
                ...
                if (response.respCode == '0'){
                    ...
                    navCachedPages['transfer/common-result/transfer-result-scr'] = null;
                    navController.pushToView('transfer/common-result/transfer-result-scr', true, 'html');
                }else {
