      ...
      <body>
        <table width='98%' align='center' class='table-account'>
          <tr class="trow-title">
            ...
            <th with="5%">
              <span>TAX_CHAPTER</span>
            </th>
            <th with="40%">
              <span>TAX_CONTENT</span>
            </th>
            <th with="45%">
              <span>COM_AMOUNT</span>
            </th>
            <th with="5%">
          ...
          <xsl:for-each select="resptable/tabletdetail">
            <tr>
              ...
              <td class="text-center">
                ...
                <div class="content-detail" >
                  <xsl:value-of select="TenTieuMuc"/>
                </div>
              </td>
              <td class="td-right">
                <div class="mobile-mode">
                ...
                <div class="content-detail" >
                  <xsl:value-of select="format-number(DuNo, '##,###,###,###,###,###,###,###')"/> VND
                </div>
              ...
              <td class="text-center">
                ...
                <div class="content-detail">
                  <input type="checkbox" class="checkTransItem" name="userRefId"></input>
                </div>
              </td>
            </tr>
          </xsl:for-each>
