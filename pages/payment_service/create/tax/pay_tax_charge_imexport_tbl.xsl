      ...
      <body>
        <table width='98%' align='center' class='table-account' style=" table-layout: fixed;">
          <tr class="trow-title">
            ...
            <th style="width: 25%">
              <span>COM_DECLAR</span>
            </th>
            <th style="width: 20%">
              <span>TAX_IM_EX_TBL_YEAR_DECLAR</span>
            </th>
            <th style="width: 45%">
              <span>TAX_IM_EX_TBL_HAI_QUAN_PHAT_HANH</span>
            </th>
          </tr>
          <xsl:for-each select="resptable/tabletdetail">
            <tr>
              ...
              <td class="text-center">
                <div class="mobile-mode text-center">
                  <span>COM_DECLAR</span>
                </div>
                <div class="content-detail">
                  <xsl:value-of select="SoTK"/>
                </div>
              </td>
              <td class="text-center">
                <div class="mobile-mode text-center">
