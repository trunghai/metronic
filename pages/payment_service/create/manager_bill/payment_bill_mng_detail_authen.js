...
function initData() {
    angular.module('EbankApp').controller('payment_bill_detail_authen', function ($scope, requestMBServiceCorp) {
        ...
        $scope.onCancelClick = function () {
            ...
            navController.pushToView('payment_service/create/manager_bill/payment_bill_mng', true, 'html');
        }
        ...
        $scope.onContinuteClick = function () {
            ...
            requestMBServiceCorp.post(data, true, function (response) {
                if (response.respCode == '0'){
                    ...
                    navCachedPages["payment_service/create/manager_bill/payment_bill_mng_detail_result"] = null;
                    navController.pushToView("payment_service/create/manager_bill/payment_bill_mng_detail_result", true);
                }else {
