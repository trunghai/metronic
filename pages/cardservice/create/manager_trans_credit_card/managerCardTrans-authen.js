...
function initData() {
    angular.module('EbankApp').controller('managerCardTrans-authen', function ($scope, requestMBServiceCorp) {
        ...
        $scope.onContinuteClick = function () {
            ...
            var args = [];
                var request = {
                    cmdType: CONSTANTS.get("CMD_CREDIT_GET_HISTORY_TRANS"),
                    request: {
            ...
            requestMBServiceCorp.post(data,true, function (response) {
                if (response.respCode == '0'){
                    ...
                    gTrans.manaCard = gTrans.result.respJsonObj;
                    if (response.respCode === '0'){
                    ...
                    navCachedPages["cardservice/create/manager_trans_credit_card/managerCardTrans-result"] = null;
                    navController.pushToView("cardservice/create/manager_trans_credit_card/managerCardTrans-result", true, 'html');
                }else {
