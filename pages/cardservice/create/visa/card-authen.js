...
function init() {
    angular.module('EbankApp').controller('card-unlock-authen', function ($scope, requestMBServiceCorp) {
        ...
        function handleOTPResendAlert(e) {
            if (currentPage == "card-unlock-authen") {
        ...
        $scope.sendJSONAuthenRequest = function (){
            ...
            // so sanh ma OTP voi man hinh nhap
            var jsonData = new Object();
            jsonData.sequenceId = "3";
            jsonData.idtxn = gTrans.idtxn;
            jsonData.idfcatref = gTrans.transInfo.idfcatref;
            var	args = new Array();
            args.push(null);
            args.push(jsonData);
            ...
            requestMBServiceCorp.post(data, true,
                function(data) {
                    ...
                    console.log(resp);
                    if (resp.respCode == 0) {
                        gTrans.comfirm = resp.respJsonObj;
                        clearOTPTimeout();
